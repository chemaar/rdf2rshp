...
public class ArtifactAbstractVisitor {

	private Class nodesType;

	public ArtifactAbstractVisitor() {
		nodesType = null;
	}

	public ArtifactAbstractVisitor(String nodesTypeName) throws ClassNotFoundException {
		this.nodesType = Class.forName(nodesTypeName);
	}

	public ArtifactAbstractVisitor(Class nodesType) {
